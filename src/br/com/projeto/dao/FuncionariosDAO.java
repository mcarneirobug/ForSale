...
public class FuncionariosDAO {
    ...
    public void cadastrarFuncionarios(Funcionarios obj) {
        try {
            ...
            stmt.setString(8, Utilitarios.retornaNuloSeVazio(obj.getTelefone()));
            stmt.setString(9, Utilitarios.retornaNuloSeVazio(obj.getCelular()));
            stmt.setString(10, Utilitarios.retornaNuloSeVazio(obj.getCep()));
    ...
    public Funcionarios consultaPorId(Integer id) {
        try {

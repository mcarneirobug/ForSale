...
public class ProdutosDAO {
    ...
    public List<String> buscaProdutosParaAutocomplete() {
    	try {
            List<String> lista = new ArrayList<>();

            String sql = "select id, descricao from tb_produtos limit 20";
            PreparedStatement stmt = con.prepareStatement(sql);
    ...
    public boolean existeProdutoId(Integer id) {
    	try {
            Long count = null;

            String sql = "select count(*) as total from tb_produtos where id = ?";
            PreparedStatement stmt = con.prepareStatement(sql);
            stmt.setInt(1, id);
    ...
    public boolean existeProdutoDescricao(String descricao) {
    	try {
            Long count = null;

            String sql = "select count(*) as total from tb_produtos where descricao = ?";
            PreparedStatement stmt = con.prepareStatement(sql);

...
public class FrmProdutos extends javax.swing.JFrame {
    ...
    public void listar() {
        ...
        for (Produtos c : lista) {
            dados.addRow(new Object[]{
                c.getId(),
                c.getDescricao(),
                Utilitarios.formatDecimalNumber(c.getPreco()),
                c.getQtd_estoque(),
    ...
    private void btnbuscaActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnbuscaActionPerformed
        ...
        if (obj.getDescricao() != null) {
            ...
            txtpreco.setText(Utilitarios.formatDecimalNumber(obj.getPreco()));
    ...
    private void btnsalvarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnsalvarActionPerformed
        ...
        campos.put("descricao", txtdescricao.getText());
        campos.put("preco", txtpreco.getText());
        campos.put("quantidade", txtqtdestoque.getText());
        
    	String erro = validaCamposObrigatórios(campos);
    	
    	if(erro.equals("")) {
    		Produtos obj = new Produtos();
    		obj.setDescricao(txtdescricao.getText());
    		obj.setPreco(Utilitarios.toDouble(txtpreco.getText()));
    		...
    		ProdutosDAO dao = new ProdutosDAO();
           	...
           	// Caso o Id esteja preenchido, o botão de salvar edita ao invés de criar um novo registro
    ...
    private String validaCamposObrigatórios(Map<String, String> campos) {
    	StringBuilder msgErro = new StringBuilder();
    	
    	if(campos.get("descricao").equals("")) {
    		msgErro.append("O campo \"Descrição\" é obrigatório.\n");
    	}
    	
    	if(campos.get("preco").equals("")) {
    		msgErro.append("O campo \"Preço\" é obrigatório.\n");
    	
    	} else if(!Utilitarios.valorMonetarioValido(campos.get("preco"))) {
    		if(campos.get("preco").contains(".")) {
    			msgErro.append("Insira o valor no campo \"Preço\" sem o caractere \".\" (ponto).\n");
    		} else {
    			msgErro.append("O campo \"Preço\" possui valores inválidos.\n");
    		}
    	} else if(Utilitarios.toDouble(campos.get("preco")) <= 0D) {
    		msgErro.append("O campo \"Preço\" só permite valores maiores que zero\".\n");
    	}
    	
    	if(campos.get("quantidade").equals("")) {
    		msgErro.append("O campo \"Quantidade\" é obrigatório.\n");
    	} else if(!Utilitarios.contemApenasNumeros(campos.get("quantidade"))
    			|| campos.get("quantidade").contains(",") 
    			|| campos.get("quantidade").contains(".")) {
    		msgErro.append("O campo \"Quantidade\" possui valores inválidos.\n");
    	} else if(Integer.parseInt(campos.get("quantidade")) < 0) {
    		msgErro.append("O campo \"Quantidade\" só permite valores maiores ou iguais a zero\".\n");
    	}
    ...
    private void jButton4ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton4ActionPerformed
    	int resposta = JOptionPane.showConfirmDialog(null, "Tem certeza que deseja excluir?", "AVISO", JOptionPane.YES_NO_OPTION);

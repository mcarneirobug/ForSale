...
public class Frmclientes extends javax.swing.JFrame {
        ...
        if(lista != null && !lista.isEmpty()) {
        	for (Clientes c : lista) {
        		dados.addRow(new Object[]{
        				...
        				c.getNome(),
        				c.getCpf(),
        				c.getInadimplente() == true ? "Sim" : "Não"
        		});
        	}
        }
    }
    ...
    private void initComponents() {
        ...
        checkPendencia = new javax.swing.JCheckBox();
        ...
        tabelaClientes.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Código", "Nome", "CPF", "Possui pendências?"
            }
        ));
        ...
        checkPendencia.setText("  Possui pendência?");
    ...
    private void btnpesquisarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnpesquisarActionPerformed
        ...
        Boolean apenasInadimplentes = checkPendencia.isSelected();
        
        ClientesDAO dao = new ClientesDAO();
        List<Clientes> lista = dao.buscaClientePorNome(nome, apenasInadimplentes);
    ...
    private void btnsalvarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnsalvarActionPerformed
        ...
        String erro = validaCamposObrigatorios(obj);
    ...
    private String validaCamposObrigatorios(Clientes cliente) {
    ...
    private void tabelaClientesMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_tabelaClientesMouseClicked
        ...
        Integer id = (Integer) tabelaClientes.getValueAt(tabelaClientes.getSelectedRow(), 0);
        
        Clientes cliente = dao.consultaPorId(id);
    ...
    private javax.swing.JCheckBox checkPendencia;

...
public class FrmPagamentos extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        txtpendencia.setFont(new java.awt.Font("Tahoma", 0, 26)); // NOI18N
            ...
            .addGroup(layout.createSequentialGroup()
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                    ...
                    .addGroup(layout.createSequentialGroup()
                        ...
                        .addGap(18, 18, 18)
                        .addComponent(txtpendencia, javax.swing.GroupLayout.PREFERRED_SIZE, 194, javax.swing.GroupLayout.PREFERRED_SIZE)))
    ...
    private void btnfinalizarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnfinalizarActionPerformed
        Double pcartao, pdinheiro, totalpago, totalvenda, troco, pendente;

        pcartao = Utilitarios.toDouble(txtcartao.getText());
        pdinheiro = Utilitarios.toDouble(txtdinheiro.getText());
        totalvenda = Utilitarios.toDouble(txttotal.getText());
        
        totalpago = pcartao + pdinheiro;
        troco = totalpago - totalvenda;
        pendente = totalvenda - totalpago;
        
        txttroco.setText(Utilitarios.toMoney(troco < 0 ? 0 : troco));
        txtpendencia.setText(Utilitarios.toMoney(pendente < 0 ? 0 : pendente));
        
        boolean possuiValorPendente = pendente > 0;
        int resposta = JOptionPane.NO_OPTION;
        
        if(possuiValorPendente) {
        	resposta = JOptionPane.showConfirmDialog(null,
        			"O valor total dos pagamentos é menor que o valor total da venda, por isso a confirmação " +
        					"da venda irá gerar um registro de pendência. Deseja confirmar?",
        					"AVISO",
        					JOptionPane.YES_NO_OPTION);
        }
    	
    	if(!possuiValorPendente || (possuiValorPendente && resposta == JOptionPane.YES_OPTION)) {
    		confirmarVenda(totalvenda, pendente);
    		JOptionPane.showMessageDialog(null, "Venda Registrada com Sucesso!");
    	}

    }//GEN-LAST:event_btnfinalizarActionPerformed
    
    private void confirmarVenda(Double totalvenda, Double valorPendente) {
		...
		objv.setPendencia_venda(valorPendente);
		...
		for (int i = 0; i < carrinho.getRowCount(); i++) {
			...
			item.setSubtotal(Utilitarios.toDouble(carrinho.getValueAt(i, 4).toString()));

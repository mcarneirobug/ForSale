...
//        jButton3 = new javax.swing.JButton();
        ...
        tabelaFuncionarios.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Código", "Nome", "CPF", "E-mail", "Cargo", "Nível Acesso"
            }
        ));
...
//                    .addComponent(jButton3, javax.swing.GroupLayout.PREFERRED_SIZE, 42, javax.swing.GroupLayout.PREFERRED_SIZE)
    ...
    private void btnbuscaActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnbuscaActionPerformed
        ...
        if (obj.getNome() != null) {
            ...
            JOptionPane.showMessageDialog(null, "FuncionÃ¡rio  nÃ£o encontrado!");
        }
    ...
    private void btnsalvarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnsalvarActionPerformed
        ...
        obj.setNivel_acesso(cbnivel.getSelectedItem() != null ? 
        			cbnivel.getSelectedItem().toString() : null);
        
        obj.setTelefone(txtfixo.getText());
        obj.setCelular(txtcel.getText());
        obj.setCep(txtcep.getText());
        obj.setEndereco(txtend.getText());
        obj.setNumero(txtnumero.getText().equals("") ? null : Integer.parseInt(txtnumero.getText()));
        obj.setComplemento(txtcomplemento.getText());
        obj.setBairro(txtbairro.getText());
        obj.setCidade(txtcidade.getText());
        
        obj.setUf(cbuf.getSelectedItem() != null ? 
        			cbuf.getSelectedItem().toString() : null);

        String erro = validaCamposObrigatórios(obj);
    ...
    private String validaCamposObrigatórios(Funcionarios funcionario) {
    	String email = funcionario.getEmail();
    	StringBuilder msgErro = new StringBuilder();
    	
    	if(funcionario.getNome() != null && funcionario.getNome().equals("")) {
    		msgErro.append("O campo \"Nome\" é obrigatório.\n");
    	}
    	if(email != null && email.equals("")) {
    		msgErro.append("O campo \"Email\" é obrigatório.\n");
    	} else if(!email.contains("@") 
    			|| (!email.endsWith(".com") && !email.endsWith(".br"))) {
    		msgErro.append("O campo \"Email\" não é válido.\n");
    	}
    	if(funcionario.getSenha() != null && funcionario.getSenha().equals("")) {
    		msgErro.append("O campo \"Senha\" é obrigatório.\n");
    	}
    	if(funcionario.getNivel_acesso() == null) {
    		msgErro.append("O campo \"Nível de Acesso\" é obrigatório.\n");
    	}
    ...
    private void tabelaFuncionariosMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_tabelaFuncionariosMouseClicked
        ...
        Integer id = (Integer) tabelaFuncionarios.getValueAt(tabelaFuncionarios.getSelectedRow(), 0);
        
        Funcionarios funcionario = dao.consultaPorId(id);

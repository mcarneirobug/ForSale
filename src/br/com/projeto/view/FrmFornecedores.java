...
//        jButton3 = new javax.swing.JButton();
        ...
        tabelaFornecedores.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Código", "Nome", "CNPJ", "E-mail", "Telefone", "Celular"
            }
        ));
...
//                    .addComponent(jButton3, javax.swing.GroupLayout.PREFERRED_SIZE, 42, javax.swing.GroupLayout.PREFERRED_SIZE)
    ...
    private void btnsalvarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnsalvarActionPerformed
        ...
        obj.setNumero(txtnumero.getText().equals("") ? 
        		null : Integer.parseInt(txtnumero.getText()));
    ...
    private String validaCamposObrigatórios(Fornecedores fornecedor) {
    	StringBuilder msgErro = new StringBuilder();
    	
    	if(fornecedor.getNome() == null 
    			|| (fornecedor.getNome() != null && fornecedor.getNome().equals(""))) {
    ...
    private void tabelaFornecedoresMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_tabelaFornecedoresMouseClicked
        ...
        if(codigo != null && !codigo.equals("")) {
        	Fornecedores fornecedor = dao.consultarPorId(Integer.parseInt(codigo));

...
public class FrmVendas extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        Autocomplete autoCompleteClientes = new Autocomplete(txtnome, sugestaoClientes);
        
        txtnome.getDocument().addDocumentListener(autoCompleteClientes);
        txtnome.getInputMap().put(KeyStroke.getKeyStroke("TAB"), COMMIT_ACTION);
        txtnome.getActionMap().put(COMMIT_ACTION, autoCompleteClientes.new CommitAction());
        
        txtdescricao.setFocusTraversalKeysEnabled(false);
        
        // Sugestão de produtos
        List<String> sugestaoProdutos = new ArrayList<String>();
        sugestaoProdutos.addAll(new ProdutosDAO().buscaProdutosParaAutocomplete());
        Collections.sort(sugestaoProdutos);
        
        Autocomplete autoCompleteProdutos = new Autocomplete(txtdescricao, sugestaoProdutos);
        
        txtdescricao.getDocument().addDocumentListener(autoCompleteProdutos);
        txtdescricao.getInputMap().put(KeyStroke.getKeyStroke("TAB"), COMMIT_ACTION);
        txtdescricao.getActionMap().put(COMMIT_ACTION, autoCompleteProdutos.new CommitAction());
    ...
    private void btnpagamentoActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnpagamentoActionPerformed
    	...
    	telap.txttotal.setText(Utilitarios.toMoney(total));
    	telap.cliente = dao.consultaPorNome(txtnome.getText());
    ...
    private void tabelaItensMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_tabelaClientesMouseClicked
//      jTabbedPane.setSelectedIndex(0);
        
        txtcodigo.setText((String) tabelaItens.getValueAt(tabelaItens.getSelectedRow(), 0));
        txtdescricao.setText((String) tabelaItens.getValueAt(tabelaItens.getSelectedRow(), 1));
        txtqtd.setText((String) tabelaItens.getValueAt(tabelaItens.getSelectedRow(), 2));
        txtpreco.setText((String) tabelaItens.getValueAt(tabelaItens.getSelectedRow(), 3));
    }
    ...
    private void btnaddActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnaddActionPerformed
    	String erros = validaProdutoInserido(txtcodigo.getText(), txtdescricao.getText(), txtqtd.getText(), txtpreco.getText());
    	
    	if(erros.equals("")) {
    		qtd = Integer.parseInt(txtqtd.getText());
    		preco = Utilitarios.toDouble(txtpreco.getText());
    		
    		subtotal = qtd * preco;
    		
    		total += subtotal;
    		txttotal.setText(Utilitarios.toMoney(total));
    ...
    private String validaProdutoInserido(String txtcodigo, String txtdescricao, String txtqtd, String txtpreco) {
    	ProdutosDAO dao = new ProdutosDAO();
    	StringBuilder erros = new StringBuilder();
    	
    	if(txtqtd.equals("") || !Utilitarios.contemApenasNumeros(txtqtd)) {
    		erros.append("Quantidade inserida é inválida.\n");
    	}
    	if(txtpreco.equals("") || !Utilitarios.valorMonetarioValido(txtpreco)) {
    		erros.append("Preço inserido é inválida.\n");
    	}
    	if(txtcodigo.equals("") || !Utilitarios.contemApenasNumeros(txtcodigo) || !dao.existeProdutoId(Integer.parseInt(txtcodigo))) {
    		erros.append("Não existem produtos cadastrados com o código preenchido.\n");
    	}
    	if(txtdescricao.equals("") || !dao.existeProdutoDescricao(txtdescricao)) {
    		erros.append("Não existem produtos cadastrados com a descrição preenchida.\n");
    	}
    ...
    private void txtcodigoKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_txtcodigoKeyPressed
        if (evt.getKeyCode() == KeyEvent.VK_ENTER) {
            ...
            txtdescricao.setText(obj != null ? obj.getDescricao() : "");
            txtpreco.setText(obj != null ? Utilitarios.toMoney(obj.getPreco()) : "");
        }
        
    }//GEN-LAST:event_txtcodigoKeyPressed
    
    private void btnremoveActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnremoveActionPerformed
    	boolean quantidadeValida = false, precoValido = false;
        
    	if(!txtqtd.getText().equals("") && Utilitarios.contemApenasNumeros(txtqtd.getText())) {
    		quantidadeValida = true;
    	}
    	if(!txtpreco.getText().equals("") && Utilitarios.valorMonetarioValido(txtpreco.getText())) {
    		precoValido = true;
    	}
    	
    	if(quantidadeValida && precoValido) {
    		qtd = Integer.parseInt(txtqtd.getText());
    		preco = Utilitarios.toDouble(txtpreco.getText());
    ...
    private void txtdescricaoKeyPressed(java.awt.event.KeyEvent evt) {                                     
        if (evt.getKeyCode() == KeyEvent.VK_ENTER) {
            ...
            obj = dao.consultaPorNome(txtdescricao.getText());
            
            txtcodigo.setText(String.valueOf(obj.getId()));
            txtdescricao.setText(obj.getDescricao());
            txtpreco.setText(Utilitarios.toMoney(obj.getPreco()));
        }
